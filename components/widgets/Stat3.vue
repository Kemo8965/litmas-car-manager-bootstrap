                    ...
                    <div>
                        <h4 class="mb-1 mt-1">
                            ...
                            <span data-plugin="counterup">
                                <countTo :startVal="0" :endVal="9" :duration="6000"></countTo>
                            </span>
                        </h4>
                        <p class="text-muted mb-0">Need Fitness & Road Tax</p>
                    </div>
        ...
        style="max-width: 20rem;">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Need Insurance & Fitness</p>
                    </div>
                    <p class="text-muted mt-3 mb-0">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <h4 class="mb-1 mt-1">
                            <span data-plugin="counterup">
                                <countTo :startVal="0" :endVal="6" :duration="6000"></countTo>
                            </span>
                        </h4>
                        <p class="text-muted mb-0">Need Insurance & Road Tax</p>
                    </div>
                    <p class="text-muted mt-3 mb-0">
                        <span class="text-danger me-1">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Need Insurance, Fitness & Road Tax</p>
                </div>
                <p class="text-muted mt-3 mb-0">
                    <span class="text-danger me-1">
                        <i class="mdi mdi-arrow-down-bold me-1"></i>6.24%
