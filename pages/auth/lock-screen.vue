                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div>
                        <nuxt-link to="/" class="mb-5 d-block auth-logo">
                            <img src="~/assets/images/libra-logo.png" alt="" height="22" class="logo logo-dark" />
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <div class="user-thumb text-center mb-4">
                                        ...
                                        <h5 class="font-size-15 mt-3">Kondwani</h5>
                                    </div>
                                    <form>
                        ...
                        <div class="mt-5 text-center">
                            <p>
                                © {{ new Date().getFullYear()}} Libra. Crafted with
                                <i class="mdi mdi-heart text-danger"></i> by Opptimus
                            </p>
                        </div>
                    </div>
                </div>
